...
class Single {
    ...
    // (статична бо метод ініціалізації може бути тільки статичний бо втратиться зміст створення одного об'єкту)
    private static Single instance;

    //Статичний метод котрий перевіряє чи змінна вже ініціалізована і якщо ні то створює один об'єкт
...
public class SingletonWithParameters {
    ...
    public void main() {
        ...
        p.sayHi();
        //Рівняєм об'єкти
        System.out.println("Чи об'єкти рівні - " + (v == p));
        //Дивимось чи хеші рівні
